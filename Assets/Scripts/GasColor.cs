...
public class GasColor : MonoBehaviour {

	public GameObject gas00; 
	...
	void Update () {
		if (Speed < 0.5f) {
			first_speed = Speed * 2;
			gas00.GetComponent<Renderer> ().material.SetColor ("_Color", Color.Lerp (Color.green, Color.yellow, first_speed));
			...
			gas00.GetComponent<Renderer> ().material.SetColor ("_Color", Color.Lerp (Color.yellow, Color.red, second_speed));
